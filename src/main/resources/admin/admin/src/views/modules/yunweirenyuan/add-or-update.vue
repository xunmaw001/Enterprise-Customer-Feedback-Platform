<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运维姓名" prop="yunweixingming">
          <el-input v-model="ruleForm.yunweixingming" 
              placeholder="运维姓名" clearable  :readonly="ro.yunweixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运维姓名" prop="yunweixingming">
              <el-input v-model="ruleForm.yunweixingming" 
                placeholder="运维姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	shouji : false,
      ...
      rules: {
          ...
          yunweixingming: [
                { required: true, message: '运维姓名不能为空', trigger: 'blur' },
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonghao = true;
          ...
          if(o=='yunweixingming'){
            this.ruleForm.yunweixingming = obj[o];
	    this.ro.yunweixingming = true;
            continue;
          }
          if(o=='mima'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yunweirenyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yunweirenyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
