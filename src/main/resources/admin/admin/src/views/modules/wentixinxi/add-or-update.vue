<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="问题状态" prop="wentizhuangtai">
          <el-select :disabled="ro.wentizhuangtai" v-model="ruleForm.wentizhuangtai" placeholder="请选择问题状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="问题状态" prop="wentizhuangtai">
	      <el-input v-model="ruleForm.wentizhuangtai"
                placeholder="问题状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='wentizhuangtai'){
            this.ruleForm.wentizhuangtai = obj[o];
	    this.ro.wentizhuangtai = true;
            continue;
          }
          if(o=='wentimiaoshu'){
	...
	this.ruleForm.wentimiaoshu = this.ruleForm.wentimiaoshu.replace(reg,'../../../springbootzypuo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
